...
.order{
  ...
  <body>
    <nav class="main-nav">
      ...
      <a href="{{route('myorders')}}" style="background-image: linear-gradient(-60deg, #d35400 0%, #f09819 100%); border-radius: 10px 0px 0px 10px;"><i class="fa-solid fa-receipt"></i> Orders</a>
    ...
    <table class="Products-table">
        ...
        <tbody>
        <tr>
        <td><p>Tofu Scramble,Vegan Pizza,Strawberry Smoothie<br><br>Value:EGP 520<br><br><span class="order">Delivered</span><br><br>on 13-07-2023</p></td>
        </tr>
        </tbody>
        </table>
</section>
